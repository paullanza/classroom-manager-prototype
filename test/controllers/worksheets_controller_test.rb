...
class WorksheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worksheet" do
    assert_difference("Worksheet.count") do
      post worksheets_url, params: { worksheet: { classroom_id: @worksheet.classroom_id, title: @worksheet.title } }
    end
  ...
  test "should update worksheet" do
    patch worksheet_url(@worksheet), params: { worksheet: { classroom_id: @worksheet.classroom_id, title: @worksheet.title } }
